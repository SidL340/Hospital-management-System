...
class LoginForm( object ):
    ...
    def loginUsers(self):
        ...
        if UserType == 'Admin':
                ...
                db.execute( "insert into adminOnly values('sm2329@srmist.edu.in', '@Test100.')" )
                db.commit()
                ...
                if CheckAdmin.fetchall():
                        ...
                        message2.setInformativeText( "Welcome to the SRM GLOBAL HOSPITAL "+ Email)
                        message2.exec_()
        ...
        # IF the usertype is 'Patient' then open another NewWindow for 'Patient' only
                ...
                if check.fetchall():
                        ...
                        message1.setInformativeText( "Welcome to the SRM GLOBAL HOSPITAL "+ Email)
                        message1.exec_()
